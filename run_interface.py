...
def main_interface():
    ...
    if files_location:
        try:
            # Check if the path is valid BEFORE attempting to access it.
            ...
            # Check if the directory is empty AFTER confirming it's a valid directory.
            ...
            with st.status("Wait: Loading knowledge base...") as status:
                ...
                if knowledge_base is None:
                    raise ValueError("Failed to build knowledge base. Check document loader for errors.")
            ...
            logging.exception(f"A critical error occurred: {e}")  # Log the full traceback for debugging
